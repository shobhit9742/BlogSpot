...
async function fetchData() {
  try {
    isFetching = true;
    let res = await fetch(
      `https://tech-tatva-2345-1.onrender.com/blog_posts?_page=${page}`
    );
...
function createCard(data) {
  ...
  document
    .getElementById("signUp_submit_btn")
...
let blog_posts = [
  {
    id: "1",
    profile_Img:
      "https://miro.medium.com/v2/resize:fill:40:40/1*KCdWeLHgIFfw5gv7fX97Eg.jpeg",
    ...
    tag: "Gambling",
    img_src:
      "https://miro.medium.com/v2/da:true/resize:fill:250:168/0*axOYB0WNLkM2gS0q",
  },
  {
    id: "2",
    profile_Img:
      "https://miro.medium.com/v2/resize:fill:40:40/1*KRWzAtSc4v6NifDIZiBrUw.png",
    ...
    description:
      "A personal experience of how too much honesty can backfire, and a good way to navigate the thin line between being sincere and being…",
    date_pub: "Mar 15, 2024",
    reading_time: "5 min read",
    by8: "·",
    tag: "Leadership",
    img_src:
      "https://miro.medium.com/v2/da:true/resize:fill:250:168/0*hZEpd7IuvYid9pUQ",
  },
  {
    id: "3",
    profile_Img:
      "https://miro.medium.com/v2/resize:fill:40:40/1*tlSJZopCPn4cndd9KrDLPg.png",
    ...
    tag: "Health",
    img_src:
      "https://miro.medium.com/v2/resize:fill:250:168/1*TYNsHKGvELRsgalw4UwIdg.png",
  },
  {
    id: "4",
    profile_Img:
      "https://miro.medium.com/v2/resize:fill:25:25/1*iosNcL2ReR-JSS2TECYd9g.png",
    author_name: "Robert Roy Britt",
    by2: "in",
    name_title: "Aha!",
    title: "Does Anybody Really Know What Time It Is?",
    description:
      "A brief history of timekeeping reveals the need for leap day, leap seconds, and the neverending challenge of synchronizing clocks around…",
    date_pub: "Feb 26, 2024",
    reading_time: "10 min read",
    by8: "·",
    tag: "Leap Year",
    img_src:
      "https://miro.medium.com/v2/da:true/resize:fill:250:168/0*c21LMdW8xH1652GP",
  },
  {
    id: "5",
    profile_Img:
    ...
    tag: "Medium",
    img_src:
      "https://miro.medium.com/v2/resize:fill:250:168/1*MnDr70SEowwqW2r_08-E_w.png",
  },
  {
    id: "6",
    profile_Img:
      "https://miro.medium.com/v2/resize:fill:40:40/1*_-1HvssC9IZ3OOgPIi3yfw.png",
    ...
    tag: "Portugal",
    img_src:
      "https://miro.medium.com/v2/resize:fill:250:168/1*-FBZJNyicWLAvPc_vBm8og.jpeg",
  },
];
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  hamburgerIcon.addEventListener("click", function () {
    menuLinks.style.display =
      menuLinks.style.display === "none" ? "block" : "none";
  });
});
